...
var _encTypeTab='all', _encContactQ='', _encContactAlpha='', _encOpenGroup='';
...
function encRender(){
  ...
  if(_encTypeTab==='all'){encRenderGrouped();return;}
...
function encRenderGrouped(){
  ...
  // Build HTML — group headers only, expand on click
