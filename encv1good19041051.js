...
console.log('[enc] encv1.js TASK3f (19042026) loaded');
...
function encModuleAction(moduleId,action){
  ...
  // Preview: only first selected, never multiple
  if(action==='preview'){
...
function encPreviewItem(id){
  var item=_encItems.find(function(i){return String(i.id)===String(id);})
  ...
  if(typeof encView==='function'){encView(item.id);return;}
