...
console.log('[enc] encv1.js TASK3h (19042026) loaded');
...
function encRenderGrouped(){
  ...
  var b4=box('#81c784','#f9fef9',
    ...
    '<div style="'+rowS+'">'+ib('&#128193;','encSetTypeTab(\'finding\')')+ib('&#128196;','encSetTypeTab(\'finding\')')+ib('&#128065;&#65039;','encSetTypeTab(\'finding\')')+bdg('finding','#fff3e0','#e65100','#ffcc80')+'<div style="'+txtS+'" onclick="encModuleOpen(\'legal_3rdparty\')">&#9679; &#1510;&#1491; &#1513;&#1500;&#1497;&#1513;&#1497; &#8212; &#1504;&#1497;&#1514;&#1493;&#1495; 0...</div></div>'+
...
var _ENC_MODULES={
  ...
  legal_3rdparty:     {title:'&#1510;&#1491; &#1513;&#1500;&#1497;&#1513;&#1497; &#8212; &#1504;&#1497;&#1514;&#1493;&#1495;',          card:'&#1499;&#1505;&#1508;&#1497;, &#1502;&#1513;&#1508;&#1496;&#1497; &#1493;&#1508;&#1512;&#1493;&#1496;&#1493;&#1511;&#1493;&#1500;'},
...
function encModulePool(moduleId){
  ...
  switch(moduleId){
    ...
    case 'legal_3rdparty':
      return _encItems.filter(function(i){
        c=(i.category||'').toLowerCase();
        return c.includes('\u05e6\u05d3 \u05e9\u05dc\u05d9\u05e9\u05d9')||c.includes('\u05de\u05e9\u05e4\u05d8\u05d9');
      });
    case 'legal_protocol':
      return _encItems.filter(function(i){
        c=(i.category||'').toLowerCase();
